...
public class LocalisationManager {
    ...
    private static final String PROCESSING_NAME_ADDITION_PREFIX = "processing.name_addition.";
    ...
    public static String processingNameAddition(String key) { return I18n.format(PROCESSING_NAME_ADDITION_PREFIX + key); }
    ...
    public static class Inventories {
        ...
        public static String countertop_title() { return I18n.format("inventories.countertop"); }
